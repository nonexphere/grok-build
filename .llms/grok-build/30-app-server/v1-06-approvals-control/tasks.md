# Tasks — v1-06-approvals-control

## Interaction model
- [ ] Persistir Interaction ID/status/type/subject/deadline/controller epoch — Follow @implementation-loop
...
- [ ] Scope grant por Session/workspace/action/identity

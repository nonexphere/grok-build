...
await client.initialize({ protocolVersion: "2026-07-18.experimental-v2", clientInfo: { name: "stdio-example", version: "1" }, capabilities: { interactions: true, reconnect: true, experimental: [] } });

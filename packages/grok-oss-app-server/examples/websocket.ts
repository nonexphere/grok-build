...
await client.initialize({ protocolVersion: "2026-07-18.experimental-v1", clientInfo: { name: "ws-example", version: "1" }, capabilities: { interactions: true, reconnect: true, experimental: [] } });
